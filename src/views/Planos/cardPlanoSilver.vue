...
<template>
  ...
  >
    <div class="plano-header">
      <h3 class="plano-nome">Plano Silver</h3>
      <div class="preco-container">
        <div v-if="precoOriginal" class="preco-original">{{ precoOriginal }}</div>
        <div class="plano-preco">{{ preco }}</div>
      </div>
      <p class="plano-descricao">Um incentivo para você começar em alto nível.</p>
    </div>
    ...
    <div class="plano-beneficios">
      ...
      <div class="beneficio">
        <span class="check">✓</span>
        Cadastre e gerencie até 5 contratos diferentes.
      </div>
      <div class="beneficio">
        <span class="check">✓</span>
