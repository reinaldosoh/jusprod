<template>
  <div>
    ...
    <div class="main-content">
      <h1 class="titulo-outras-despesas">Outras Despesas</h1>
      ...
      <div class="lista-container">
        <ListaOutrasDespesas 
          ...
          @visualizar-outras-despesas="handleVisualizarOutrasDespesas"
          @editar-outras-despesas="handleEditarOutrasDespesas"
          @excluir-outras-despesas="handleExcluirOutrasDespesas"
        />
      </div>
    </div>
    ...
    <div v-if="formOutrasDespesasVisivel" class="modal-overlay">
      <FormsOutrasDespesas 
        :dados-edicao="outrasDespesasSelecionada"
...
import ListaOutrasDespesas from '../Financeiro/lista_outras_despesas.vue';
import FormsOutrasDespesas from '../Financeiro/formsOutrasDespesas.vue';
...
// Estados para o modal de outras despesas
const formOutrasDespesasVisivel = ref(false);
const outrasDespesasSelecionada = ref(null);
...
const handlePesquisa = (termo) => {
  ...
  console.log('Pesquisando outras despesas:', termo);
  // O filtro é aplicado automaticamente através da prop termoPesquisa
};

// === HANDLERS OUTRAS DESPESAS ===
const handleVisualizarOutrasDespesas = (outrasDespesas) => {
  console.log('👁️ Visualizando outras despesas:', outrasDespesas);
  outrasDespesasSelecionada.value = outrasDespesas;
  modoVisualizacaoOutrasDespesas.value = true;
  formOutrasDespesasVisivel.value = true;
};

const handleEditarOutrasDespesas = (outrasDespesas) => {
  console.log('✏️ Editando outras despesas:', outrasDespesas);
  outrasDespesasSelecionada.value = outrasDespesas;
  modoVisualizacaoOutrasDespesas.value = false;
  formOutrasDespesasVisivel.value = true;
};

const handleExcluirOutrasDespesas = (outrasDespesas) => {
  console.log('✅ [OutrasDespesas] Outras despesas excluída - lista já recarregada:', outrasDespesas);
...
const fecharFormOutrasDespesas = () => {
  ...
  outrasDespesasSelecionada.value = null;
  modoVisualizacaoOutrasDespesas.value = false;
};
...
/* Sobrescrever largura fixa do componente lista_outras_despesas para usar toda a largura disponível */
.lista-container :deep(.lista-outras-despesas-container) {
  width: 100% !important;
